...
class Ward3Controller extends Controller
{
    /**
    ...
    {
        // $beds = Beds::all();
        $beds = Beds::where('bed_number','LIKE','3%')->orderby('bed_number')->get();


        return view('ward3.w3',compact('beds'));
    }
    ...
    public function edit($bed_number)
    {
        ...
        return view('ward3.w3-edit',compact('beds','start_date','end_date'));
    }
