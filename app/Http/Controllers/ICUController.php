...
class ICUController extends Controller
{
    ...
    {
        // $beds = Beds::all();
        $beds = Beds::where('bed_number','LIKE','ICU%')->orderby('bed_number')->get();

        return view('icu.icu',compact('beds','duration'));
    }
    ...
    public function edit($bed_number)
    {
        ...
        return view('icu.icu-edit',compact('beds','start_date','end_date'));
    }
    ...
    public function fetching(){
        ...
        return view('icu.icu',compact('beds'));
    }
}
